# Generated by Django 4.2.1 on 2024-09-16 07:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0005_protocolhubzuglaufseiltrommel_newhubzug_protocol2'),
    ]

    operations = [
        migrations.CreateModel(
            name='ProtocolHubzugMassSeiltrommel',
            fields=[
        ...
        migrations.AlterField(
            ...
            name='protocol1',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.protocolhubzugliftinghost'),
        ),
        migrations.AlterField(
            model_name='newhubzug',
            name='protocol2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.protocolhubzuglaufseiltrommel'),
        ),
        migrations.AddField(
            model_name='newhubzug',
            name='protocol3',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.protocolhubzugmassseiltrommel'),
        ),
    ]
